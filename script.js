document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateSubmitButton() {
        ...
        if (method === 'email') {
            ...
            formInfoText.textContent = 'Your form and attached documents will be sent directly to our notary. We\'ll review and contact you on WhatsApp with next steps.';
        } else {
    ...
    submitBtn.addEventListener('click', function (e) {
        ...
        if (method === 'whatsapp') {
            ...
            if (fileNames.length) whatsappMsg += '*Documents:* ' + fileNames.join(', ') + '\n';
            if (message) whatsappMsg += '*Details:* ' + message + '\n';
            whatsappMsg += '\nI have ' + (fileNames.length || 'no') + ' document(s) ready to send for inspection.';
